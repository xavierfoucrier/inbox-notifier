namespace notifier {
	partial class Main {
		...
		private void InitializeComponent() {
			...
			this.fieldAudioNotification.Checked = true;
			...
			this.fieldNumericDelay.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
			...
			this.fieldStartWithWindows.Checked = true;
			...
			this.fieldAskonExit.Checked = true;
